...
// HACK: [] include trackers here for late addition to a derived GameModeInvasion metagame
...
void main(dictionary@ inputData) {
    ...
    // HACK: [] some of these CB6 things require XP and RP, improve reward factor and starting amounts
    ...
    array<string> overlays = { "media/packages/invasion", "media/packages/" };
    settings.m_overlayPaths = overlays;

    // HACK: [] don't automatically start a server for CB6 testing
